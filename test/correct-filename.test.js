...
describe('publicPath option', () => {
  ...
  it('should override public path when given empty string', () => {
    expect(run('/file.txt', 'publicPath=').result).toEqual('module.exports = "81dc9bdb52d04dc20036dbd8313ed055.txt";');
  });
  it('should use webpack public path when not set', () => {
    expect(run('/file.txt').result).toEqual('module.exports = __webpack_public_path__ + "81dc9bdb52d04dc20036dbd8313ed055.txt";');
  });
});

describe.skip('useRelativePath option', () => {
  it('should be supported', () => {
...
describe.skip('outputPath function', () => {
  it('should be supported', () => {
